  ...
  return (
    <>
      <section className="custom-scrollbar rightsidebar">
        <div class="w-80 max-w-sm p-4 bg-slate-800 overflow-x-hidden border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
          <h5 class="mb-3 text-base font-semibold text-gray-200 md:text-xl dark:text-white">
            Connect wallet
          </h5>
          <ul class="my-4 space-y-3">
            <li>
              <button class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-300 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                <svg
                  aria-hidden="true"
                  class="h-4"
                  viewBox="0 0 40 38"
          ...
          <div>
            ...
            {account ? (
              ...
              <button
                ...
                className="mt-4 px-4 py-2 text-sm font-semibold text-white bg-blue-500 rounded-lg hover:bg-blue-600"
              >
                Connect Wallet
              </button>
            )}
